...
const Footer = () => {
  return (
    <div className='bg-[#1D7EB9] h-60'>
      <div className='container flex flex-col items-center justify-center text-center text-white mt-14
              md:px-6 md:py-8 md:text-lg'>
        <h1 className='text-3xl mb-2'>Ready to Make an App and UX that stands out?</h1>
      ...
      <footer className="bg-gray-800 text-white py-8">
        ...
        <div className='container mx-auto flex flex-col md:flex-row justify-center items-center mt-5 mb-4'>
        ...
        <div className='absolute left-0 right-0 bg-[#151E23] py-1 px-4 text-center text-white'>
          <p>© 2023 Vereda Digital Learning. All Rights Reserved.</p>
        </div>
      </footer>
    </div>
  );
